    ...
    return (
        <div className="add-trans-box modal frosted white-1 host-grotesk">
            ...
            <form id="add-trans-form" onSubmit={handleSubmit}>
                <div>
                    <textarea id="title" placeholder="Person Name"></textarea>
                    <input type="number" placeholder="0.00" min="0.01" step="0.01" required />
